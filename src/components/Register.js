          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            {step === "register" ? (
              ...
              <>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6 mt-10">
                  <div>
                  ...
                  <button
                    ...
                    className={`flex w-full justify-center rounded-md ${
                      resendCountdown > 0 ? "bg-gray-400" : "bg-indigo-600"
...
//                 />
//                 <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Sign up to your account</h2>
//                 <p className="mt-2 text-sm/6 text-gray-500">
//                   Already a member?{' '}
